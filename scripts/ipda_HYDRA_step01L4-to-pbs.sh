...
-i <path/to/input/folder>   path/from/working/dir/to/HYDRA_step01L3_quality-check-raw-files_FastQC_DATE/
...
logfile=logfile_ipda_HYDRA_step01L4-to-pbs_${thislogdate}.txt
...
out_path_step01L4_MultiQC="HYDRA_step01L4_quality-check-raw-files_MultiQC_${thislogdate}"
...
echo "${multiqc} ${input} -o ${out_path_step01L4_MultiQC}" >> ${pbs_stem}_${thislogdate}.pbs
