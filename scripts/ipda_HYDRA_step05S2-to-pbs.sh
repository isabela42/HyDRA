...
-i <path/to/input/folder>   path/from/working/dir/to/HYDRA_step05S1_quality-check-after-trimming_FastQC_DATE/
...
logfile=logfile_ipda_HYDRA_step05S2-to-pbs_${thislogdate}.txt
...
out_path_step05S2_MultiQC="HYDRA_step05S2_quality-check-after-trimming_MultiQC_${thislogdate}"
...
echo "${multiqc} ${input} -o ${out_path_step05S2_MultiQC}" >> ${pbs_stem}_${thislogdate}.pbs
