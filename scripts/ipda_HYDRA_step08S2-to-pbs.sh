...
logfile=logfile_ipda_HYDRA_step08S2-to-pbs_${thislogdate}.txt

#................................................
#  Additional information
#................................................

## List colors for DeepTools
# This may be in hex code or actual names
# One for each sample #30
initial_colors="#61bcc6;#ade66c;#f11e71;#9cd5d8;#6213fe;#e17ebb;#f7dc02;#a14b74;#a66fc7;#de08e3;#be1f5f;#1838f9;#d6fd2e;#16a184;#5b1119;#b9f9f7;#57e148;#0c4b0e;#a88f99;#4b8623;#0c170d;#cfc154;#424cab;#669dd7;#3a06a8;#ec5a5e;#56dac1;#e4d2d6;#262f4f;#b3d17e"
...
# Python3
# DeepTools in /software/python/Python-3.6.1/bin/deeptools
...
out_path_step08S2_DeepTools="HYDRA_step08S2_replicates-correlation_DeepTools_${thislogdate}"
...
echo 'echo "# DeepTools available in /software/python/Python-3.6.1/bin/deeptools"' >> ${pbs_stem}_${thislogdate}.pbs
...
bams=`cut -f2 ${input} | sort | uniq | tr '\n' ' '` ; labels=`cut -f1 ${input} | cut -d"_" -f12- | tr '\n' ' '` ; echo "multiBamSummary bins --bamfiles ${bams} --labels ${labels} --outFileName ${out_path_step08S2_DeepTools}/bam-comparison-summary_${pbs_stem}.npz --maxFragmentLength 280 --numberOfProcessors ${ncpus}" >> ${pbs_stem}_${thislogdate}.pbs
echo "" >> ${pbs_stem}_${thislogdate}.pbs
