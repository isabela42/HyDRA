...
logfile=logfile_ipda_HYDRA_step09S1-to-pbs_${thislogdate}.txt
...
out_path_step09S1_FastQC="HYDRA_step09S1_quality-check-after-ribodepletion_FastQC_${thislogdate}"
