...
logfile=logfile_ipda_HYDRA_step11H1-to-pbs_${thislogdate}.txt
...
out_path_step11H1_rnaSPAdes="HYDRA_step11H1_de-novo-transcriptome-assembly_rnaSPAdes_${thislogdate}"
...
echo "seqtk seq ${out_path_step11H1_rnaSPAdes}/transcripts.fasta > seqtk seq ${out_path_step11H1_rnaSPAdes}/transcripts.singleline.fasta " >> ${pbs_stem}_${thislogdate}.pbs
echo "" >> ${pbs_stem}_${thislogdate}.pbs
