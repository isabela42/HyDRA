...
-i <path/to/input/files>    Input TSV files including path FROM working
                            ...
                            path/from/working/dir/to/HYDRA_step13H1_polish-assembly_Nanopolish_25102023102025AEST/stem_merged.fasta
...
out_path_step13H1_GMAP_Bowtie2="HYDRA_step13H1_read-representation_GMAP_Bowtie2_${thislogdate}"
