...
-i <path/to/input/files>    Input TSV files including path FROM working
                            ...
                            Col2:
                            path/from/working/dir/to/HYDRA_step11H*_de-novo-transcriptome-assembly_*_DATE/insilico_read_normalization/left.norm.fq
                            of .Trinity.fasta derived files.

                            Col3:
                            path/from/working/dir/to/HYDRA_step11H*_de-novo-transcriptome-assembly_*_DATE/insilico_read_normalization/right.norm.fq
                            of .Trinity.fasta derived files.
...
logfile=logfile_ipda_HYDRA_step13H2-to-pbs_${thislogdate}.txt
...
out_path_step13H2_Bowtie2="HYDRA_step13H2_read-representation_Bowtie2_${thislogdate}"
