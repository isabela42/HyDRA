...
-i <path/to/input/files>    Input TSV files including path FROM working
                            ...
                            Col1:
                            path/from/working/dir/to/HYDRA_step11H2_de-novo-transcriptome-assembly_*_DATE/stem/stem.fasta
...
logfile=logfile_ipda_HYDRA_step14H1-to-pbs_${thislogdate}.txt
...
out_path_step14H1_GMAP="HYDRA_step14H1_splicing-assessment_GMAP_${thislogdate}"
...
sed -i 's,${reference_gmap_db},'"${reference_gmap_db}"',g' "$logfile"
