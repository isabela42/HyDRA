...
Usage: bash ipda_HYDRA_step17H1-to-pbs.sh -i "path/to/input/files" -p "PBS stem" -e "email" -m INT -c INT -w "HH:MM:SS"
...
logfile=logfile_ipda_HYDRA_step17H1-to-pbs_${thislogdate}.txt
...
out_path_step17H1_Bash="HYDRA_step17H1_summary_Bash_${thislogdate}"
...
step=`echo ${folder} | cut -d"_" -f2` ; n=`echo ${folder} | cut -d"_" -f2 | cut -d"p" -f2` ; if [[ "${step}" == "step12H1" ]]; then
...
header="Step\tSample\tDatabase\tComplete\tComplete-perc\tComplete-sc\tComplete-sc-perc\tComplete-duplicated\tComplete-duplicated-perc\tFragmented\tFragmented-perc\tMissing\tMissing-perc\tTotal\tBase-file"
...
col03="Eukaryota"
col04=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A2 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Complete
col05=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f1 | cut -d":" -f2`;        # Complete-perc
col06=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A3 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Complete-sc
col07=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f2 | cut -d":" -f2`;        # Complete-sc-perc
col08=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A4 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Complete-duplicated
col09=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f3 | cut -d":" -f2`;        # Complete-duplicated-perc
col10=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A5 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Fragmented
col11=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f4 | cut -d":" -f2`;        # Fragmented-perc
col12=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A6 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Missing
col13=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f5 | cut -d":" -f2`;        # Missing-perc
col14=`grep -A48 "## Run BUSCO for Eukaryota at" ${pbs_o} | grep -A7 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Total
col15=`echo "$(basename ${pbs_o})"`;                    # Base-file
...
col02=`echo "$(basename ${pbs_o})" | cut -d"_" -f5`;    # Sample
col03="Vertebrata"
col04=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A2 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Complete
col05=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f1 | cut -d":" -f2`;        # Complete-perc
col06=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A3 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Complete-sc
col07=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f2 | cut -d":" -f2`;        # Complete-sc-perc
col08=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A4 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Complete-duplicated
col09=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f3 | cut -d":" -f2`;        # Complete-duplicated-perc
col10=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A5 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Fragmented
col11=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f4 | cut -d":" -f2`;        # Fragmented-perc
col12=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A6 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Missing
col13=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f5 | cut -d":" -f2`;        # Missing-perc
col14=`grep -A48 "## Run BUSCO for Vertebrata at" ${pbs_o} | grep -A7 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Total
col15=`echo "$(basename ${pbs_o})"`;                    # Base-file
...
col02=`echo "$(basename ${pbs_o})" | cut -d"_" -f5`;    # Sample
col03="Mamalia"
col04=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A2 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Complete
col05=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f1 | cut -d":" -f2`;        # Complete-perc
col06=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A3 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Complete-sc
col07=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f2 | cut -d":" -f2`;        # Complete-sc-perc
col08=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A4 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Complete-duplicated
col09=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f3 | cut -d":" -f2`;        # Complete-duplicated-perc
col10=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A5 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Fragmented
col11=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f4 | cut -d":" -f2`;        # Fragmented-perc
col12=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A6 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Missing
col13=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A1 "Results:" | tail -n1 | cut -f2 | cut -d"%" -f5 | cut -d":" -f2`;        # Missing-perc
col14=`grep -A48 "## Run BUSCO for Mamalia at" ${pbs_o} | grep -A7 "Results:" | tail -n1 | cut -f2 | cut -d" " -f1`;        # Total
col15=`echo "$(basename ${pbs_o})"`;                    # Base-file
...
cut -f1 ${input} | while read folder; do
step=`echo ${folder} | cut -d"_" -f2` ; n=`echo ${folder} | cut -d"_" -f2 | cut -d"p" -f2` ; if [[ "${step}" == "step12H2" ]]; then
...
col05=`ls ${folder} | grep "${col02}" | while read file ; do grep "Total trinity transcripts:" ${folder}/${file} | cut -f2 ; done`;        # #Transcripts
col06=`ls ${folder} | grep "${col02}" | while read file ; do grep "Percent GC:" ${folder}/${file} | cut -f2 ; done`;        # GC%
col07=`ls ${folder} | grep "${col02}" | while read file ; do grep -A3 "ALL" ${folder}/${file} | tail -n1 | cut -d" " -f3 ; done`;        # N10
col08=`ls ${folder} | grep "${col02}" | while read file ; do grep -A4 "ALL" ${folder}/${file} | tail -n1 | cut -d" " -f3 ; done`;        # N20
col09=`ls ${folder} | grep "${col02}" | while read file ; do grep -A5 "ALL" ${folder}/${file} | tail -n1 | cut -d" " -f3 ; done`;        # N30
col10=`ls ${folder} | grep "${col02}" | while read file ; do grep -A6 "ALL" ${folder}/${file} | tail -n1 | cut -d" " -f3 ; done`;        # N40
col11=`ls ${folder} | grep "${col02}" | while read file ; do grep -A7 "ALL" ${folder}/${file} | tail -n1 | cut -d" " -f3 ; done`;        # N50
col12=`ls ${folder} | grep "${col02}" | while read file ; do grep -A9 "ALL" ${folder}/${file} | tail -n1 | cut -d" " -f4 ; done`;        # Median-len
col13=`ls ${folder} | grep "${col02}" | while read file ; do grep -A10 "ALL" ${folder}/${file} | tail -n1 | cut -d" " -f3 ; done`;        # Average-len
col14=`ls ${folder} | grep "${col02}" | while read file ; do grep -A11 "ALL" ${folder}/${file} | tail -n1 | cut -d" " -f4 ; done`;        # Assembled-bases
col15=`echo "$(basename ${pbs_o})"`;                    # Base-file
...
cut -f1 ${input} | while read folder; do
step=`echo ${folder} | cut -d"_" -f2` ; n=`echo ${folder} | cut -d"_" -f2 | cut -d"p" -f2` ; if [[ "${step}" == "step14H1" ]]; then
...
col01="${step}";                                        # Step
col02=`echo "$(basename ${pbs_e})" | cut -d"_" -f5`;    # Sample #-f5-6 for gems, -f5 for hydra development
...
#echo -e "file\tduplicates_unspliced\tduplicates_spliced\tduplicates_unaligned\tsingle_unspliced\tsingle_spliced\tsingle_unaligned" >> HYDRA_step16H1_splicing-assessment_GMAP_counts.tsv ; ls ../*/HYDRA_step16H1_splicing-assessment_GMAP_*/*/*_splicing-assessment.genome.sam | while read file ; do duplicates_unspliced=`grep -v "^@" $file | awk '$1 ~ /@/ || ($6 !~ /N/ && $6 !~ /\*/)' | cut -f1 | sort | uniq -c | cut -d" " -f7- | grep -v "^1" | wc -l`; duplicates_spliced=`grep -v "^@" $file | awk '$1 ~ /@/ || ($6 ~ /N/)' | cut -f1 | sort | uniq -c | cut -d" " -f7- | grep -v "^1" | wc -l` ; duplicates_unaligned=`grep -v "^@" $file | awk '$1 ~ /@/ || ($6 ~ /\*/)' | cut -f1 | sort | uniq -c | cut -d" " -f7- | grep -v "^1" | wc -l` ; single_unspliced=`grep -v "^@" $file | awk '$1 ~ /@/ || ($6 !~ /N/ && $6 !~ /\*/)' | cut -f1 | sort | uniq -c | cut -d" " -f7- | grep "^1" | wc -l`; single_spliced=`grep -v "^@" $file | awk '$1 ~ /@/ || ($6 ~ /N/)' | cut -f1 | sort | uniq -c | cut -d" " -f7- | grep "^1" | wc -l` ; single_unaligned=`grep -v "^@" $file | awk '$1 ~ /@/ || ($6 ~ /\*/)' | cut -f1 | sort | uniq -c | cut -d" " -f7- | grep "^1" | wc -l` ; echo -e "${file}\t${duplicates_unspliced}\t${duplicates_spliced}\t${duplicates_unaligned}\t${single_unspliced}\t${single_spliced}\t${single_unaligned}" >> HYDRA_step16H1_splicing-assessment_GMAP_counts.tsv ; done
