...
-i <path/to/input/files>    Input TSV files including path FROM working
                            ...
                            Col1:
                            path/from/working/dir/to/HYDRA_step18H*_coding-potential_ezLncPred_DATE/stem/stem
                            of all *.noncoding files, but don't .CNCI.noncoding, .CPAT.noncoding and .CPC2.noncoding

                            Col2:
                            path/from/working/dir/to/HYDRA_step19H*_lncRNA-potential_FEELnc_DATE/stem/codport_stem/stem.lncRNAclasses.txt
...
logfile=logfile_ipda_HYDRA_step20H1-to-pbs_${thislogdate}.txt
...
out_path_step20H1_Bash="HYDRA_step20H1_predicted-lncRNAs_Bash_${thislogdate}"
