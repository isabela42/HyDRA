...
-i <path/to/input/folder>   path/from/working/dir/to/hydra01S1_qc-raw_FastQC_DATE/
...
logfile=logfile_ipda_hydra01S2-to-pbs_${thislogdate}.txt
...
out_path_step01S2_MultiQC="hydra01S2_qc-raw_MultiQC_${thislogdate}"
