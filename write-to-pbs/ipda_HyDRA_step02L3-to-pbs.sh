...
-i <path/to/input/files>    Input TSV files including path FROM working
                            ...
                            Col1:
                            path/from/working/dir/to/hydra02L2_trim-qc-head_Chopper_DATE/stem
                            of .fastq.gz file and no full stops.

                            Col2:
                            path/from/working/dir/to/hydra02L2_trim-qc-head_Chopper_DATE/stem.fastq.gz
...
logfile=logfile_ipda_hydra02L3-to-pbs_${thislogdate}.txt
...
out_path_step02L3_Cutadapt="hydra02L3_trim-polyA_Cutadapt_${thislogdate}"
