...
-i <path/to/input/folder>   path/from/working/dir/to/hydra03L3_qc-trim_FastQC_DATE/
...
logfile=logfile_ipda_hydra03L4-to-pbs_${thislogdate}.txt
...
out_path_step03L4_MultiQC="hydra03L4_qc-trim_MultiQC_${thislogdate}"
