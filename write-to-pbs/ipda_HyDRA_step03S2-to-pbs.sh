...
-i <path/to/input/folder>   path/from/working/dir/to/hydra03S1_qc-cor_FastQC_DATE/
...
logfile=logfile_ipda_hydra03S2-to-pbs_${thislogdate}.txt
...
out_path_step03S2_MultiQC="hydra03S2_qc-cor_MultiQC_${thislogdate}"
...
echo "${module_multiqc} ${input} -o ${out_path_step03S2_MultiQC}" >> ${pbs_stem}_${thislogdate}.pbs
