...
-i <path/to/input/files>    Input TSV files including path FROM working
                            ...
                            Col1:
                            path/from/working/dir/to/hydra04S1_trim-adapters_Trimmomatic_DATE/adapter-trimmed_unfixrm
                            of both _R1.fq.gz and _R2.fq.gz files in individual lines
                            and no full stops.

                            Col2:
                            path/from/working/dir/to/hydra04S1_trim-adapters_Trimmomatic_DATE/adapter-trimmed_unfixrm_*_R1.fq.gz (line 1)
                            path/from/working/dir/to/hydra04S1_trim-adapters_Trimmomatic_DATE/adapter-trimmed_unfixrm_*_R2.fq.gz (line 2)
...
logfile=logfile_ipda_hydra04S2-to-pbs_${thislogdate}.txt
...
out_path_step04S2_BBDuk="hydra04S2_qc-ends-avg_BBDuk_${thislogdate}"
