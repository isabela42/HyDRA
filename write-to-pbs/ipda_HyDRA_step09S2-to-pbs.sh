...
-i <path/to/input/folder>   path/from/working/dir/to/hydra09S1_qc-ribodepleted_FastQC_DATE/
...
logfile=logfile_ipda_hydra09S2-to-pbs_${thislogdate}.txt
...
out_path_step09S2_MultiQC="hydra09S2_qc-ribodepleted_MultiQC_${thislogdate}"
