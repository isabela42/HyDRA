...
-i <path/to/input/files>    Input TSV files including path FROM working
                            ...
                            Col1:
                            path/from/working/dir/to/hydra06S1_ribodepletion_BBDuk_DATE/header-fixed_ribo-depleted_adapter-trimmed_unfixrm_stem
                            of both _R1.cor.fq.gz and _R2.cor.fq.gz header-fixed files in individual lines
                            and no full stops.

                            Col2:
                            path/from/working/dir/to/hydra06S1_ribodepletion_BBDuk_DATE/stem_R1.cor.fq.gz (line 1)
                            path/from/working/dir/to/hydra06S1_ribodepletion_BBDuk_DATE/stem_R2.cor.fq.gz (line 2)
...
logfile=logfile_ipda_hydra11H2-to-pbs_${thislogdate}.txt
...
out_path_step11H2_Trinity="hydra11H2_assembly_Trinity_${thislogdate}"
